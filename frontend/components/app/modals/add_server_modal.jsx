            ...
            <div className="add-server-modal">
                ...
                <div className="cards-container">
                    <div className="card">
                        ...
                        <button onClick={() => this.props.openModal({ name: "createServer" })} className="modal__btn modal__btn--blue">Create a server</button>
                    </div>
                    ...
                    <div className="card margin-left--l">
                        ...
                        <button onClick={() => this.props.openModal({ name: "joinServer" })} className="modal__btn modal__btn--green">Join a server</button>
                    </div>
                </div>
